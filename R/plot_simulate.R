...
#' @param lag.max Maximum lag to compute. Specified in terms of saved time 
#' points. For example, `lag.max = 10` corresponds to 10 time units and 100 
#' lags with `save_at = 0.1`.
